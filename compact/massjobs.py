...
outputarea="/data/users/elevy127/dd4hep2/DD4hep/examples/DualTestBeam/compact/output/"
hostarea="/data/users/elevy127/dd4hep2/DD4hep/examples/DualTestBeam/compact/jobs/"
...
while (i<nenergy):
    ...
    shfile.write('cd /data/users/elevy127/dd4hep2/DD4hep/examples/DualTestBeam/compact/'+'\n')
    ...
    shfile.write('source  /data/users/elevy127/dd4hep2/DD4hep/bin/thisdd4hep.sh'+'\n')
...
# DO IT BOTH PLACES!!!
    shfile.write('ddsim --compactFile=/data/users/elevy127/dd4hep2/DD4hep/examples/DualTestBeam/compact/DR'+args.geometry+'.xml --runType=batch -G --steeringFile /data/users/elevy127/dd4hep2/DD4hep/examples/DualTestBeam/compact/SCEPCALsteering.py --outputFile='+outputarea+'out_'+args.geometry+'_'+str(energies[i])+'GeV_e-.root --part.userParticleHandler='' -G --gun.position="0.,0*mm,-1*cm" --gun.direction "0 0.0 1." --gun.energy "'+str(energies[i])+'*GeV" --gun.particle="e-" -N 100 >& '+outputarea+'sce_e_'+args.geometry+'_'+str(energies[i])+'.log'+'\n')
...
while (i<nenergy):
    ...
    shfile.write('source  /data/users/elevy127/dd4hep2/DD4hep/bin/thisdd4hep.sh'+'\n')
    shfile.write('echo "ran thisdd4hep"'+'\n')
    shfile.write('ddsim --compactFile=/data/users/elevy127/dd4hep2/DD4hep/examples/DualTestBeam/compact/DR'+args.geometry+'.xml --runType=batch -G --steeringFile /data/users/elevy127/dd4hep2/DD4hep/examples/DualTestBeam/compact/SCEPCALsteering.py --outputFile='+outputarea+'out_'+args.geometry+'_'+str(energies[i])+'GeV_pi-.root --part.userParticleHandler='' -G --gun.position="0.,0*mm,-1*cm" --gun.direction "0 0.0 1." --gun.energy "'+str(energies[i])+'*GeV" --gun.particle="pi-" -N 100 >& '+outputarea+'sce_pi_'+args.geometry+'_'+str(energies[i])+'.log'+'\n')
    shfile.write('exitcode=$?'+'\n')
    shfile.write('echo ""'+'\n')
    shfile.write('END_TIME=`/bin/date`'+'\n')
    shfile.write('echo "finished at $END_TIME"'+'\n')
